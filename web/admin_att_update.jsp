<%-- 
    Document   : admin_att_update
    Created on : Nov 3, 2012, 11:50:35 PM
    Author     : Kushal
--%>
  ...
  if(j==1)
      {
      ...
      else
          {
            $.ajax({
                        url:"update_att",
                        type:"POST",
                        data:{cat:$("#cat").val(),lev:$("#lev").val(),id:$("#id").val(),fnames:$("#fnames").val(),lnames:$("#lnames").val(),cno:$("#cno").val(),add:$("#add").val(),dob:$("#dob").val(),doj:$("#doj").val()},    
                        success:function(dt){
                            alert(dt);
        ...
        <form name="updtform" id="contacts-form" defaultbutton="Update" defaultfocus="#fname">
                                        ...
                                        <div class="field text">
                                            ...
                                            <select name="cat" id="cat">
                                                <option selected Value="${emp.cat_id}">${emp.cat}</option>
                                        ...
                                        <div class="field text">
                                            ...
                                            <select name="lev" id="lev">
                                                <option selected Value="${emp.level_id}">${emp.level}</option>
