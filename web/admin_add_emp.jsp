<%-- 
    Document   : admin_add_emp
    Created on : Nov 3, 2012, 7:01:59 PM
    Author     : Kushal
--%>
  ...
  if(j==1)
      {
      ...
      else
          {
            $.ajax({
                        url:"add_emp",
                        type:"POST",
                        data:{email:$("#email").val(),fnames:$("#fnames").val(),lnames:$("#lnames").val(),cno:$("#cno").val(),add:$("#add").val(),dob:$("#dob").val(),doj:$("#doj").val()},    
                        success:function(dt){
                            alert(dt);
