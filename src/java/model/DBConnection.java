...
public class DBConnection {
    ...
    public boolean connect() {
        try {
            ...
            dbCon = DriverManager.getConnection("jdbc:mysql://localhost:3306/isupport", "root", "root");
            if (!dbCon.isClosed()) {
                return true;
            }
...
//insert update delete
    ...
    public ResultSet selectRecords(String tableName) throws SQLException {
        try {
            dbCon.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
