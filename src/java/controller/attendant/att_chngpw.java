 ...
 * @author Umang
 */
@WebServlet(name = "att_chngpw", urlPatterns = {"/att_chngpw"})
public class att_chngpw extends HttpServlet {
        ...
        try {
            chng_password c=new chng_password();
                ...
                if(e.chng_pw(c))
                {
                    ...
                    response.sendRedirect("att_change_password.jsp");
                }
                else
                {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(att_chngpw.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
