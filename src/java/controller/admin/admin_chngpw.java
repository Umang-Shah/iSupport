 ...
 * @author Umang
 */
@WebServlet(name = "admin_chngpw", urlPatterns = {"/admin_chngpw"})
public class admin_chngpw extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(admin_chngpw.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
