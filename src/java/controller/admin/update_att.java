 ...
 * @author Umang
 */
@WebServlet(name = "update_att", urlPatterns = {"/update_att"})
public class update_att extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            e.setEmp_id(Integer.parseInt(request.getParameter("id")));
